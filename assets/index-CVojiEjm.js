...
`,PO=Se.div`
  display: flex;
  gap: 8px;
`;function NO(n){return pe.jsxs(SO,{children:[pe.jsx("img",{src:"./StatusBar.svg"}),pe.jsxs(PO,{children:[pe.jsx(xO,{children:pe.jsx("img",{src:"./ToonChat/Triangle.svg"})}),pe.jsxs(RO,{children:[pe.jsx(CO,{children:"제목"}),pe.jsx(DO,{children:"제목"})]})]})]})}const OO=()=>{};var Jb={};/**
 * @license
...
justify-content: center;
height: 100vh;
`;function C5(n){const{userListData:e,nowuser:t,setUser:i}=oT(),a=e.map(l=>pe.jsx("li",{onClick:()=>{i(l)},children:l.name},l.id));return pe.jsxs(R5,{children:[pe.jsxs("ul",{children:[pe.jsxs("p",{children:["현재 유저 : ",t==null?void 0:t.name]}),a]}),pe.jsx(yN,{children:pe.jsx(_S,{index:!0,element:pe.jsx(S5,{})})})]})}const D5=({children:n})=>pe.jsx(X9,{children:pe.jsx(l5,{children:n})});function x5(){return pe.jsx(TN,{basename:"/ToonChat",children:pe.jsx(D5,{children:pe.jsx(C5,{})})})}OP.createRoot(document.getElementById("root")).render(pe.jsx(ge.StrictMode,{children:pe.jsx(x5,{})}));
